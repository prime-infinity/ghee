...
export const InteractiveDiagramComponent: React.FC<InteractiveDiagramProps> = ({
  ...
  // Convert DiagramData to React Flow format
  const { nodes, edges } = useMemo(() => {
    ...
    const flowEdges: Edge[] = diagramData.edges.map((visualEdge) => ({
      ...
      animated: visualEdge.animated || false,
      style: {
  ...
  // Handle fit view when diagram data changes
  React.useEffect(() => {
...
export default InteractiveDiagramComponent;
